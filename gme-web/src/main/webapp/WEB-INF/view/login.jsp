				...
				<div class="right_mcontent clearfix">
					<div class="maichu">
						...
						<div class="m_con rightlogin">
							<form role="form" id="loginForm" name="login" method="post" action="${ctx}/userLogin.html">
								...
								<div class="form-group has-feedback clearfix" id="codeGroup">
									...
									<div class="clearfix code-box">
										...
										<div id="code"><img class="cap-img" id="loginCaptcha" src="${pageContext.request.contextPath}/api/v1/user/imgCode.html" alt="Captcha" title="看不清？换一张" onclick="document.getElementById('loginCaptcha').src = '${pageContext.request.contextPath}/api/v1/user/imgCode.html?' + Math.random(); return false" /></div>
										<span class="help-block"></span>
									</div>
								</div>
